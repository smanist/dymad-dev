...
| A new standalone convergence-study primitive, reusable study adapter, aggregation, rate-fit, diagnostic, or summary plotting behavior | `src/dymad/studies/convergence/*` | Keep study orchestration independent of MCP/CLI exposure; user-facing exposure would be a later registry/compiler/executor change |
