...
cfgs = [
    (
        ...
        DLDMG,
        NODETrainer,
        {"data": {"path": data_path}, "model": mdl_kb, "training": trn_nd},
    ),
]
...
if ifprd:
    ...
    for _i in IDX:
        ...
        model_graph = visualize_model(
            ...
            depth=1,
            ifsave="kura_model/kura_model",
        )

    plot_trajectory(np.array(res), t_data, "LTGV", labels=["Truth"] + labels, ifclose=False)
