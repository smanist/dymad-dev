...
from scripts.pirom_res.res_train import DPJ, DPT, B, f, mdl_kl, t_grid, trn_nd, trn_wf
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run PI-ROM residual algebraic cases.")
