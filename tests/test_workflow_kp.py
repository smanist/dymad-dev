...
crit_part = {"dynamics": {"weight": 1.0}, "recon": {"weight": 1.0}}
crit_full = {
    "dynamics": {"type": "wmse", "weight": 1.0, "params": {"alpha": 0.5}},
    "recon": {"type": "mse", "weight": 1.0, "params": {"reduction": "sum"}},
}
crit_pred = {"type": "wmse", "params": {"alpha": -0.5}}

ls_opt = {"method": "truncated", "params": 2, "interval": 3, "times": 2}
trn_wf = {
    "n_epochs": 10,
    "save_interval": 5,
...
cv = {
    "param_grid": {"model.hidden_dimension": [16, 32], "training.sweep_epoch_step": [3, 5]},
    "metric": "total",
}
...
cfgs = [
    ...
    (
        ...
        KBF,
        WeakFormTrainer,
        {"model": mdl_kb, "prediction_criterion": crit_pred, "training": trn_wf},
    ),
