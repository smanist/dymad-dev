...
BASELINE_PATH = Path(__file__).with_name("slow_ker_lti_cli_baselines.json")
TEST_SEED = 12345
EVAL_SEED = 12346
...
CASES = [
    Case(0, "km_ln", KM, metric_factors={"crit_train_last": 3.0, "crit_valid_last": 3.0}),
    Case(2, "dkm_ln", DKM, metric_factors={"best_valid_total": 5.0, "final_valid_loss": 5.0}),
    Case(4, "dks_ln", DKMSK),
]
...
def test_ker_lti_cli(case: Case, tmp_path: Path, request, baseline_store):
